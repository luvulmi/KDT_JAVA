	...
	<form action="/Web02/mupdate" method="post">
		...
		-->
			...
			<tr height="40">
				...
				<td><select name="jno">
						<option value="1" ${apple.jno==1 ? "selected": ""}>1조:
							굉장해엄청나</option>
						<option value="2" ${apple.jno==2 ? "selected": ""}>2조:
							구해조</option>
						<option value="3" ${apple.jno==3 ? "selected": ""}>3조:
							백업은 기본이조</option>
						<option value="4" ${apple.jno==4 ? "selected": ""}>4조:
							상호형 빵사조</option>
						<option value="5" ${apple.jno==5 ? "selected": ""}>5조:
							(주)식빵</option>
						<option value="7" ${apple.jno==7 ? "selected": ""}>7조:
							칠면조</option>
				</select></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				<td><input type="text" name="point" size="20"
